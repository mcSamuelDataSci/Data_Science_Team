---
title: " 'HS Team Data' Planning and Resource Documenet"
output:
...
*  The Team will then decide together what tools (e.g. software) to use moving forward, and decide what web applications and/or other "products" to build based on interests and motivations of team members
* Core team focus will be on retrieving/collected data, organizing and curating data, and analyzing and displaying data, BUT there would be some great team roles for other students/members like artists (design of pictures and logos), school leaders (suggesting directions for team projects), and others.
