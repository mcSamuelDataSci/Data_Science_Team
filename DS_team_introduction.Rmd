...
### "Big Picture - Fun stuff"

* We will look at all sorts of "big" and "open" data, and explore generating visualizations with various tools. We can definately have some fun with [this app](http://toddwschneider.com/posts/ballr-interactive-nba-shot-charts-with-r-and-shiny/) made in R Shiny, looking at lots of data for every single NBA player.
...
hist(selected_info$Perc9a, breaks=20, col="red",
     main=paste("How do Kids in Ninth Grade in California Score\n on the",test_selected,"part\n of the Annual Fitness Test?"),cex.main=1.2,
     xlab = "Score"
)
...
ggplot(selected_info, aes(x=Perc9a)) + 
        ...
        ggtitle(paste("How do Kids in Ninth Grade in", county_selected,"County Score\n on the Six Tests of the Annual Fitness Test?"))
```
