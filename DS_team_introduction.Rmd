...
* We will look at all sorts of "big" and "open" data, and explore data with various tools. We can definately have some fun with [this app](http://toddwschneider.com/posts/ballr-interactive-nba-shot-charts-with-r-and-shiny/), looking at lots of data for every single NBA player
